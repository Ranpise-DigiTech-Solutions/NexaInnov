  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-100">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-5xl font-extrabold text-primary-blue dark:text-white text-center mb-4">🍽 Restaurant Management System</h1>
        ...
        <section className="mb-12">
          <p className="text-center text-lg text-neutral-800 dark:text-gray-300 mb-8">This system helps restaurants streamline daily operations, improve customer experience, and maximize efficiency—all in one powerful platform.</p>
          <h2 className="text-3xl font-bold text-primary-blue dark:text-white mb-4">🌟 Key Features & Functionalities</h2>
