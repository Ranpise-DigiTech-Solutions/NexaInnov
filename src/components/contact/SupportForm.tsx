// components/contact/SupportForm.tsx
...
const SupportForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...formData,
        type: 'support-query', // ✅ CHANGE THIS: Set the type to 'support-query'
      };
      ...
      // ✅ CHANGE THIS: Update toast message for support
      toast({ title: "Message Sent!", description: "Your support query has been sent." });
