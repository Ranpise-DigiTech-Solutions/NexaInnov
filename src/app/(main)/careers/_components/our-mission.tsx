    ...
    <div className="min-h-fit w-full flex items-center justify-center">
      <div className="w-[90%] lg:w-[85%] h-full flex flex-col items-center justify-center gap-8">
        <div className="w-full flex flex-col items-center justify-center gap-4">
          <p className="text-center text-3xl md:text-4xl lg:text-5xl font-bold text-wrap text-primary-blue dark:text-neutral-200">
            Interested in our <br /> mission ?
          </p>
          <p className="w-[90%] md:w-[75%] lg:w-[55%] text-neutral-800 dark:text-neutral-500 text-sm lg:text-base leading-6 lg:leading-7 text-center">
        ...
        <div className="w-full flex flex-col md:flex-row items-center justify-center gap-8">
          <div className="flex-1 min-h-[200px] flex flex-col items-stretch justify-center gap-4 bg-blue-300 dark:bg-neutral-800 rounded-2xl text-center p-4">
            <PeopleAltIcon
              fontSize="medium"
            ...
            <p className="text-white dark:text-neutral-400 font-normal text-sm md:text-base line-clamp-3 lg:line-clamp-2 text-wrap">
