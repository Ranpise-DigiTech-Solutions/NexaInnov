...
const JoinUsComponent = (props: Props) => {
  return (
    <div className="min-h-[500px] w-full pb-[3rem] px-[4rem] flex items-center justify-between gap-4 text-neutral-200">
      <div className="w-[55%] h-full flex flex-col items-center justify-center gap-8">
