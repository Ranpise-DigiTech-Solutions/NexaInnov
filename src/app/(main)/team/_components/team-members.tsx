...
const TeamMembersComponent = (props: Props) => {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center gap-6 text-neutral-200">
      <div className="w-full text-center text-4xl font-bold">
        Our Leadership Team
      </div>
      <div className="w-full text-center text-wrap text-neutral-400 leading-7">
      ...
      <div className="w-full p-[2rem] flex flex-row items-center justify-center flex-wrap gap-8">
        <Link href={"/team/ceo"}>
