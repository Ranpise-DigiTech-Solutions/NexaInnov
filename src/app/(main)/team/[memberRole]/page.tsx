...
const TeamMemberProfilePage = ({ params }: Props) => {
  const teamMemberRole = params.memberRole;
            ...
            <div className="w-full h-full p-[1rem] flex flex-col items-center justify-center gap-12">
              <div className="w-full flex flex-col items-center justify-center gap-6">
                ...
                <p className="text-neutral-200 leading-7">
                  ...
                  Itaque ipsum quas excepturi assumenda distinctio, tempora,
                  veniam quis cupiditate cum corporis similique, illum provident
                  optio quam autem voluptatum? Minima distinctio iure eos esse,
                  nam commodi quisquam eius laudantium doloribus nisi earum
                  dolorum ipsa itaque? Quam, velit minima! Maiores ducimus optio
                  possimus?
                </p>
              </div>
              <div className="w-full flex flex-col items-center justify-center gap-6">
