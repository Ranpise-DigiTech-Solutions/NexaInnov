  ...
  return (
    <div className="min-h-screen text-neutral-200 w-full flex items-center justify-center">
      <div className="w-[90%] xl:w-[75%] h-full flex flex-col gap-[3rem] ">
        ...
        <Button className="flex md:hidden items-center justify-center transform transition-transform duration-300 hover:scale-105 hover:bg-primary-black bg-neutral-700 xl:p-8 lg:px-6 md:py-8 px-4 py-6 rounded-full">
            <p className="w-full h-full xl:text-xl md:text-lg text-base tracking-wide text-neutral-200 rounded-full flex items-center justify-center">
              Browse all articles
            </p>
          </Button>
      </div>
