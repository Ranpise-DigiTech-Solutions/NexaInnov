    ...
    >
      <div className="w-full lg:w-[80%] flex flex-col items-center justify-center gap-[4rem]">
        <div className="w-full flex flex-col items-center justify-center gap-4">
          ...
          <p className="w-full lg:w-[60%] text-center text-sm md:text-base lg:text-lg font-neutral text-no-wrap text-neutral-800 dark:text-neutral-500 leading-5 md:leading-7">
        ...
        <div className="w-full flex flex-col items-center justify-center gap-16">
          <div className="w-full flex flex-row items-center justify-center gap-6 md:gap-8">
            <div className="group relative w-[50%] h-[200px] bg-blue-600 dark:bg-neutral-700 rounded-tr-[4rem] rounded-bl-[4rem] flex flex-col items-center justify-center gap-2 md:gap-4 transform transition-all duration-500 hover:translate-y-4">
              ...
              <p className="w-[90%] text-lg md:text-xl lg:text-2xl font-bold text-white dark:text-neutral-300 text-center transform transition-all duration-300  group-hover:text-primary-pink">
                Collaboration
              </p>
              <p className="w-[80%] text-sm md:text-base text-wrap text-white dark:text-neutral-400 leading-6 lg:leading-7 line-clamp-4 md:line-clamp-3 lg:line-clamp-2 truncate text-center">
